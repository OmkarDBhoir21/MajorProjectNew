...
export const rightArrow = <i className="fa-solid fa-arrow-right"></i>
export const leftArrow = <i className="fa-solid fa-arrow-left"></i>
// export const uplaadIcon = <i class="fa-duotone fa-arrow-up-from-bracket"></i>
// export const faSpinner = <i class="fa fa-spinner" aria-hidden="true"></i>
// export const faTrash = <i class="fa-regular fa-trash"></i>
// export const faFileAlt = <i class="fa-regular fa-file-lines"></i>
export const uploadIcon = <i className="fa-solid fa-cloud-arrow-up"></i>
export const trashIcon = <i className="fa-solid fa-trash"></i>
export const spinnerIcon = <i className="fa-solid fa-spinner"></i>
export const fileAltIcon = <i className="fa-solid fa-file-lines"></i>
// export const uploadIcont1 = <i class="fa-solid fa-upload"></i>
export const acceptIcon = <i className="fa-solid fa-check"></i>
export const rejectIcon = <i className="fa-solid fa-xmark"></i>